		...
		<td style="background-color:#222 ; width: 20vw;horizontal-align:right; vertical-align:top">
			<div class="nav">
			  <div id = "logInBtns">
				...
				<input type="password" placeholder="Enter Password" value = "<?php echo $pass ?>" name="psw" id="loginPassword" class ="loginField" onFocus="if (deadTimer == -1) pauseGame(); document.getElementById('logInResponse').innerHTML='';">
